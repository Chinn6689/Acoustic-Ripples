class Splash {
  constructor() {
    ...
    this.info = createDiv("Acoustic Ripples is an interactive audiovisual installation that transforms sound into liquid geometry. By using a microphone to capture environmental noise or playing the digital piano through keys 1 to 7, you can generate vibrant, pulsating ripples on a dark and meditative surface. At its core, the project utilizes Fast Fourier Transform (FFT) to perform real-time frequency analysis. This allows the installation to distinguish between various pitches: deep, low-frequency sounds create broad and powerful waves, while high-pitched tones generate delicate, rapid ripples. This project explores the boundary between the invisible nature of sound and the fluid elegance of water, allowing you to paint with your voice, rhythm, and touch. You can speak to the screen, play your favorite music, or use the keyboard to compose your own visual melody. <p> <a href='https://editor.p5js.org/chinn6689/sketches/pJfU77LjH' target='_blank'>view code</a>");
